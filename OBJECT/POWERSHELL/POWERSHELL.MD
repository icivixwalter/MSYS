POWERSHELL.MD
	...
	NOTE
		i comandi di powershell da sistermare in archivio tutorial, per orma viene salvato
		in questa directory, poi è da posizionare in modo completo e definitivo.

			@powershell_(@shell di @windows in alternativa al dos, @TUTORIAL@powershell)
