...
@REM 02) Posso così caricare il mio valore di configurazione dal file root.config nella mia variabile root:
	...
	@REM  impostata la variabile path del file da aprire e poi richiamata. CARICO LA PATH DA FILE ESTERNO
		...
		SET WORD365_s="C:\Program Files\Microsoft Office\root\Office16\WINWORD.EXE"
		...
		SET FILE_s=HELP_ANALISI_MSYS.docx
		

		echo off
		echo apro con WORD365_s e la path  ed il file da aprire %FILE_s%

		START "APRI FILE	" %WORD365_s% "%DISCO_s%%PATH_s%%FILE_s%"
