...
'//-----------------------------------------------------------------------------------//
    ...
    Dim frmProgress As Form_frmProgressBar          ' Dichiarazione globale per il riferimento alla form
      ...
      questa collezione.
        ...
        Case "GE_ESPROPRI.mdb"
            ...
            '//-------------------------------------------------------------------------------------//
                '//@CONDOMINIO@TABELLE@GIURIDICA
                 Case "IMPORTA_OGGETTI_CDM_GIUR"
                        objectTables.Add "GECOND_DF01_}--------------------------------------------------@"
                        objectTables.Add "GECOND_DF01_TIPI"
                
                '//@CONDOMINIO@TABELLE@CONSUNTIVO
                Case "IMPORTA_OGGETTI_CDM_CONS"
                        objectTables.Add "CONS_TB09_}----------------------------------------------------@"
                        objectTables.Add "CONS_TB09_MASTRO"
                        
                '//@CONDOMINIO@TABELLE@ANAGRAFICA
                Case "IMPORTA_OGGETTI_CDM_ANAGR"
                        objectTables.Add "ANAGR_Tb01_}---------------------------------------------------@"
                        objectTables.Add "ANAGR_TB01_PROPRIETARI"
                        objectTables.Add "ANAGR_Tb02_}---------------------------------------------------@"
                        objectTables.Add "ANAGR_Tb02_PROPR_CONDOM"
                        objectTables.Add "ANAGR_Tb03_LOCAZIONI"
                        objectTables.Add "ANAGR_TB04_PEC_EMAIL"
                ...
                Case "IMPORTA_OGGETTI_CDM_GE_PREV"
                            objectTables.Add "PREV_TB09_}----------------------------------------------------@"
                            objectTables.Add "PREV_TB09_DEF_SPESA"
                            objectTables.Add "PREV_TB09_DEF_VOCI"
                            objectTables.Add "PREV_TB09_PREVENTIVO"
                            objectTables.Add "PREV_TB25_}----------------------------------------------------@"
                            objectTables.Add "PREV_TB25_RIPARTO_PREV_MATTEI_2023"
        
                '//@CONDOMINIO@TABELLE@TABELLE@MILLESIMALI
                Case "IMPORTA_OGGETTI_CDM_GE_TABELLE"
                        objectTables.Add "TB01_MIL_}-----------------------------------------------------@"
                        objectTables.Add "TB01_MILL"
                        objectTables.Add "TB01_PROPR_}---------------------------------------------------@"
                        objectTables.Add "TB01_PROPR_GEN"
                        
                '//@CONDOMINIO@TABELLE@TABELLE@UTILITA
                Case "IMPORTA_OGGETTI_CDM_GE_UTIL"
                        objectTables.Add "UTIL_TB20_}----------------------------------------------------@"
                        objectTables.Add "UTIL_Tb20_N01_GESTIONE_PROGETTI"
                        objectTables.Add "UTIL_Tb20_N01_REPLICHE_OGGETTO"
...
Public Sub CaricaOggetti_UTILITA(ByRef coll_Tables_UTILITA As Collection, _
    ...
    '//@UTILITA@COLLECTION@FORMS_(LE @FORM  per la @GESTIONE DELLE @UTILITA@FORMS)
      ...
      '// ... questa è la form per la gestione dei file windows a cui si unisce ache il modulo PER LE @API@WINDOWS
        ...
        colForms_UTILITA.Add "frmProgressBar"
    '//-------------------------------------------------------------------------------------------------------//
...
Private Sub Form_Load()
    ...
    '//IMPOSTO LA CASELLA COMBINATA IN PARTENZA @cmb@abilitazioni_(vari @codici dei @progetti)
        ...
        Str1 = Str1 & "IMPORTA_IMPEGNI;"                     '//@IMPORTA@OGGETTI@TREEVIEW
        Str1 = Str1 & ""
          ...
          If Bool1 = False Then
                ...
                Next Queries_Name_v
                        ...
                        '//---------------------------------------------------------------------------//
                                        ...
                                        ' Chiudi la QUERY frmProgressBar
                                        DoCmd.Close acForm, "frmProgressBar", acSaveNo
          ...
          If Bool1 = False Then
                ...
                Next Modules_Name_v
                        ...
                        '//---------------------------------------------------------------------------//
                                        ...
                                        ' Chiudi la MODULI frmProgressBar
                                        DoCmd.Close acForm, "frmProgressBar", acSaveNo
...
Public Function Nro_Collection_Pfunct() As Integer
    ...
    Dim formsCollection As Form_frmProgressBar ' <-- Cast esplicito al tipo corretto
    Dim NroCollection_i As Integer
