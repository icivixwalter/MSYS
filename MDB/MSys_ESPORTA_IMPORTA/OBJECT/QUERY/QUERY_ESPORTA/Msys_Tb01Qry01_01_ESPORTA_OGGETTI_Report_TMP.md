Msys_Tb01Qry01_01_ESPORTA_OGGETTI_Report_TMP
...
## sql
    ...
    FROM
        ...
        INNER JOIN (
            ...
            Msys_Tb01_ESPORTA_ELENCO_OGGETTI_DB_TMP.PATH_s = Msys_Tb01_ESPORTA_DB_EST.PATH_s
        )
        AND (
            Msys_Tb01_ESPORTA_ELENCO_OGGETTI_DB_TMP.COD_PROGETTO_s = Msys_Tb01_ESPORTA_DB_EST.COD_PROGETTO_s
        )
    WHERE
        (
            (
