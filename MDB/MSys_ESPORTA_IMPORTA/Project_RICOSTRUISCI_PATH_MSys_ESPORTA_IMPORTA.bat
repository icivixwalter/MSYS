...
@REM  ATTENZIONE, ho inserito il nome MSys_ESPORTA_IMPORTA3 a posto di MSys_ESPORTA_IMPORTA per evitare
...
set "TARGET=c:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MSYS\MDB\MSys_ESPORTA_IMPORTA3\"
