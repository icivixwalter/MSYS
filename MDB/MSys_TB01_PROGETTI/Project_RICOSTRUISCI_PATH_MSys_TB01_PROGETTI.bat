...
@REM  ATTENZIONE, ho inserito il nome MSys_TB01_PROGETTI3 a posto di MSys_TB01_PROGETTI per evitare
...
set "TARGET=c:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MSYS\MDB\MSys_TB01_PROGETTI3\"
