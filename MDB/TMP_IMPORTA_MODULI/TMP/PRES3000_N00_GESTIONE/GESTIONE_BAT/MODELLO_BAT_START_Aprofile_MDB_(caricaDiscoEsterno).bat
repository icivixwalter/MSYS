...
@rem esempio SET /P DISCO_s=<DISCO_Default.TXT
	...
	SET PATH_03_s=\MODELLO_MDB\
	SET FILE_s=MODELLO_DbBase.mdb
...
echo. path ricostruita: \GESTIONI\GESTIONE_LLPP\25_GESTIONE_LLPP\\LLPP_ARCHIVI_MDB\AA_MODELLO\\MODELLO_MDB\
