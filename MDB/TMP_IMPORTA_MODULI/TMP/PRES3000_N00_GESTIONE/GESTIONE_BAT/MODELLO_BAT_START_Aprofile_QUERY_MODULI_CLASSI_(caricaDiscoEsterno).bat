...
@rem esempio SET /P DISCO_s=<DISCO_Default.TXT
	...
	SET PATH_03_s=\MODELLO_QUERY_ROUTINE_MODULI_CLASSI\
	SET FILE_s=MODELLO_QUERY_AREA_DI_LAVORO.tws
...
echo. 
echo. path ricostruita: \GESTIONI\GESTIONE_LLPP\25_GESTIONE_LLPP\\LLPP_ARCHIVI_MDB\AA_MODELLO\\MODELLO_QUERY_ROUTINE_MODULI_CLASSI\
