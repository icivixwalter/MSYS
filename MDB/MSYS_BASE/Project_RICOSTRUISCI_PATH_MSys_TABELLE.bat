...
@REM  ATTENZIONE, ho inserito il nome MSYS_BASE3 a posto di MSYS_BASE per evitare
...
set "TARGET=c:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MSYS\MDB\MSYS_BASE3"
