...
@REM  ATTENZIONE, ho inserito il nome MSys_TB03_ELENCO_OGGETTI3 a posto di MSys_TB03_ELENCO_OGGETTI per evitare
...
set "TARGET=c:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MSYS\MDB\MSys_TB03_ELENCO_OGGETTI3"
