...
@REM  ATTENZIONE, ho inserito il nome MSys_TABELLE3 a posto di MSys_TABELLE per evitare
...
set "TARGET=C:\CASA\LINGUAGGI\ACCESS\PROGETTI_MDB\MSYS_OGGETTI\MSYS\MDB\MSys_TABELLE3"
